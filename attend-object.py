...
with model:
    visual_stim = nengo.Node([1.0, 0, 1.0])
    positions = nengo.Node([-0.25,0,0.25])
    v1_column1 = nengo.Ensemble(n_neurons=100, dimensions=1, radius=1, max_rates=Uniform(90,120))
    v1_column2 = nengo.Ensemble(n_neurons=100, dimensions=1, radius=1, max_rates=Uniform(90,120))
    v1_column3 = nengo.Ensemble(n_neurons=100, dimensions=1, radius=1, max_rates=Uniform(90,120))
    nengo.Connection(positions[0], v1_column1)
    nengo.Connection(positions[1], v1_column2)
    nengo.Connection(positions[2], v1_column3)
    
    controls = nengo.Node([0.25, 1])
    control_neurons = nengo.Ensemble(n_neurons=200, dimensions=2, radius=1, max_rates=Uniform(90,120))
    nengo.Connection(controls, control_neurons)
    
    MT_terminal1 = nengo.Ensemble(n_neurons=300, dimensions=3, radius=1, max_rates=Uniform(90,120))
    MT_terminal2 = nengo.Ensemble(n_neurons=300, dimensions=3, radius=1, max_rates=Uniform(90,120))
    MT_terminal3 = nengo.Ensemble(n_neurons=300, dimensions=3, radius=1, max_rates=Uniform(90,120))
    ...
    gating1 = nengo.Ensemble(n_neurons=300, dimensions=3, radius=1, max_rates=Uniform(90,120))
    gating2 = nengo.Ensemble(n_neurons=300, dimensions=3, radius=1, max_rates=Uniform(90,120))
    gating3 = nengo.Ensemble(n_neurons=300, dimensions=3, radius=1, max_rates=Uniform(90,120))
    ...
    MT_column1 = nengo.Ensemble(n_neurons=100, dimensions=1, radius=1, max_rates=Uniform(90,120))
    MT_column2 = nengo.Ensemble(n_neurons=100, dimensions=1, radius=1, max_rates=Uniform(90,120))
    MT_column3 = nengo.Ensemble(n_neurons=100, dimensions=1, radius=1, max_rates=Uniform(90,120))
    ...
    intermediate = nengo.Ensemble(n_neurons=300, dimensions=3, radius=1, max_rates=Uniform(90,120))
